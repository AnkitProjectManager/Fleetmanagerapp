...
export class InMemoryDatabase {
  constructor() {
    ...
    // Ready for production - no sample data initialized
  }
  ...
  // Get total record count for health check
  getTotalRecordCount() {
    return Object.values(this.data).reduce((total, collection) => total + collection.length, 0);
  }
